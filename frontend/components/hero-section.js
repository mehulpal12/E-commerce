        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            <div className="relative aspect-square md:aspect-[4/5] overflow-hidden rounded-lg">
              <Image width={250} height={350} src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/attachments/gen-images/public/fashionable-couple-wearing-trendy-clothes-VLFHxpbo041wouwgENhaGCTKxLKXQI.jpg" alt="Fashionable couple" className="object-cover w-full h-full" />
              {/* Decorative Stars */}
